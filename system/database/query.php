...
class query extends Builder
{
    ...
    /**
     * Specify the columns to select from the database.
     *
     * @param array|string $columns Columns to select. Can be an array of column names or a single column name. If not specified, defaults to '*'.
     * @return \System\database\query Returns the current instance for method chaining.
     */
    public function select($columns = ['*'])
    {
        // If columns is a single column name, convert it to an array for consistency
        if (!is_array($columns)) {
            $columns = [$columns];
        }

        // Store the columns to select, mapping each column through the wrap method
        // to ensure proper formatting and prevent potential SQL injection
        $this->columns = array_map([$this, 'wrap'], $columns);
     ...
     * @param array $bindings Optional array of parameters to bind to the expression.
     * @return \System\database\query Returns the current instance for method chaining.
     */
    public function raw($expression, array $bindings = [])
    {
