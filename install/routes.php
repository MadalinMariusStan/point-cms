...
Route::get('database', [
    ...
    'main'   => function () {
        ...
        $vars['collations'] = [
            ...
            'utf8mb4_unicode_520_ci'=> 'Unicode (multilingual) UCA 5.2.0, case-insensitive',
            'utf8mb4_unicode_900_ci'=> 'Unicode (multilingual) UCA 9.0.0, case-insensitive',
            'utf8mb4_bin'           => 'Unicode (multilingual), Binary',
            'utf8mb4_croatian_ci'   => 'Croatian, case-insensitive',
            ...
            'utf8mb4_german_ci'     => 'German dictionary order, case-insensitive',
            ...
            'utf8mb4_sinhala_ci'    => 'Sinhala, case-insensitive',
            ...
            'utf8mb4_thai_520_w2'   => 'Thai, case-insensitive, UCA 5.2.0',
            'utf8mb4_turkish_ci'    => 'Turkish, case-insensitive',
            'utf8mb4_unicode_520_bin'=> 'Unicode UCA 5.2.0, Binary',
            'utf8mb4_vietnamese_ci' => 'Vietnamese, case-insensitive',
            'utf8mb4_ja_0900_as_cs' => 'Japanese, accent-sensitive, case-sensitive, UCA 9.0.0',
        ];
...
Route::post('metadata', [
    'before' => 'check',
    'main'   => function () {
        $metadata = Input::get(['site_name', 'site_description', 'site_path','site_email', 'theme', 'rewrite']);
...
Route::get('complete', function () {
    ...
    $vars['delete_install'] = rtrim($settings['metadata']['site_path'], '/') . '//index.php/admin/install/delete';
