<?php echo $header; ?>
    <section class="content mt-5">
        <article>
            <h1>Site metadata</h1>
            <p>In order to personalise your blog, it's recommended you add some metadata about your site. This can all
                be
        ...
        <form method="post" action="<?php echo Uri::to('metadata'); ?>" autocomplete="off">
            <fieldset>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
          <textarea id="site_description" class="form-control" name="site_description"
                    rows="5"><?php echo Input::previous('site_description',
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label" for="site_email">Site Email</label>
                    <div class="col-sm-10">
                        <input id="site_email" class="form-control" name="site_email"
                               value="<?php echo Input::previous('site_email', 'your_email@domain.com'); ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <?php if (count($themes) > 1): ?>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select id="theme" class="form-select" name="theme" data-width="100%">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php if (mod_rewrite()): ?>
                            <div class="more">Looks like you are running apache with <code>mod_rewrite</code>
                                enabled.<br>
                                The installer will create the htaccess for you.
                            </div>
                        <?php elseif (is_apache()): ?>
                            <div class="more">Looks like you are running apache, but <code>mod_rewrite</code> is not
                                enabled.
                            </div>
                        ...
                        <?php elseif (is_nginx()): ?>
                            <div class="more">Looks like you are running <code>Nginx</code>. </div>
                        <?php elseif (is_cgi()): ?>
                            <div class="more">Looks like you are running <code>PHP</code> as a FastCGI process. You will
                                have to set up your own URL rewriting.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
