    ...
    <form method="post" action="<?php echo uri_to('database'); ?>" autocomplete="off">
        <fieldset>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select id="collation" class="form-select" name="collation" data-live-search="true" data-width="100%">
                        <?php foreach ($collations as $code => $description): ?>
                    ...
                    <span class="form-text">Change if <b>Unicode (multilingual), case-insensitive</b> doesn’t work.</span>
                </div>
            </div>
        </fieldset>
        <section class="mt-3">
