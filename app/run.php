...
try {
    ...
    if (ini_get('display_errors') != "1") {
        echo "<h2>Something went wrong, please notify the owner of the site</h2>";
    } else {
        Errors::exception($e);
    }
...
if (is_admin()) {
    ...
    require APP . 'routes/subscribers' . EXT;
    require APP . 'routes/users' . EXT;
    require APP . 'routes/variables' . EXT;
    require APP . 'routes/visitors' . EXT;
