...
class auth
{
    ...
    /**
     * Checks whether the current user is an contributor
     *
     * @return bool
     * @throws \Exception
     */
    ...
    {
        if ($id = Session::get(static::$session)) {
            return User::find($id)->role == 'contributor';
        }
    ...
    /**
     * Checks whether the current user is an demo
     *
     * @return bool
     * @throws \Exception
     */
