<?php echo $header; ?>
    <div class="d-flex mt-3 mb-3">
        <div class="me-auto"><h3><?php echo __('users.users'); ?></h3></div>
        <?php if (Auth::admin()) : ?>
            <div class="ps-2">
                <?php echo Html::link('admin/users/add',__('users.create_user'), [
        ...
        <div class="d-flex border-top pt-3 pb-3">
            ...
            <div class="flex-shrink-0">
                <div class="ml-auto d-none d-lg-inline pl-3">
                    ...
                    <?php else: ?>
                        <?php $avatar = Uri::to('app/views/assets/img/no_image.png'); ?>
                    <?php endif; ?>
                    <img src="<?php echo $avatar; ?>" alt="<?php echo $user->real_name; ?>" class="mr-2 ml-3 shadow-inner rounded-circle" style="width: 57px; height: 57px;">
                </div>
                <div class="d-inline d-lg-none pl-5 ml-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 24 24"
                        ...
                        <path d="M10.3 8.7a1 1 0 0 1 1.4-1.4l4 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 0 1-1.4-1.4l3.29-3.3-3.3-3.3z" class="fill-light-gray"></path>
                    </svg>
                </div>
            </div>
        </div>
