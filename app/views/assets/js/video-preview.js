document.addEventListener("DOMContentLoaded", () => {
  ...
  function showPreview() {
    ...
    if (isYouTubeLink(videoLink)) {
      ...
      document.getElementById("video-preview").innerHTML = "<div class=\"mt-5\">Invalid video link</div>";
    }
  }
  ...
  if (videoLinkInput.value.trim() !== "") {
    ...
    document.getElementById("video-preview").innerHTML = "<div class=\"mt-5 pt-5\">No link entered</div>";
  }
});