...
<head>
    ...
    <title>404</title>
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $base . '/assets/favicon/apple-touch-icon.png'; ?>"/>
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $base . '/assets/favicon/favicon-32x32.png'; ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $base . '/assets/favicon/favicon-16x16.png'; ?>">
    <!-- Boostrap Css -->
...
<div class="container mx-auto">
        ...
        <div class="col-md-6 offset-md-3 mt-3">
            <svg viewBox="0 0 900 600" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M118.142 373.556c31.081 18.628 75.673 1.408 75.673 1.408s-5.831-47.416-36.931-66.023c-31.081-18.629-75.654-1.429-75.654-1.429s5.83 47.416 36.912 66.044z"
                      fill="url(#d)"/>
                <circle cx="747.028" cy="208.246" r="12.989" transform="rotate(180 747.028 208.246)" fill="#666AF6"/>
                <circle cx="257.822" cy="281.817" r="14.612" transform="rotate(180 257.822 281.817)" fill="#666AF6"/>
    ...
    <p class="text-center">Take me <a class="btn btn-outline-dark" href="<?php echo $base . '/admin/'; ?>">home</a></p>
</div>
</body>
</html>