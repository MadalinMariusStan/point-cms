<?php echo $header; ?>
    ...
    <h3 class="mt-3"><?php echo __('subscribers.subscribers'); ?></h3>
    <a class="mt-3 text-decoration-none" href="<?php echo Uri::to('admin/extend/subscribers'); ?>">
        <div class="border-top pt-3 pb-3">
            <h5 class="text-body-emphasis"><strong><?php echo __('subscribers.subscribers_list'); ?></strong></h5>
            <span class="text-muted"><?php echo __('subscribers.subscribers_desc'); ?></span>
        </div>
    </a>
<?php echo $footer; ?>