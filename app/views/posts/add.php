<?php echo $header; ?>
    <form id="form-add" method="post" action="<?php echo Uri::to('admin/posts/add'); ?>" enctype="multipart/form-data" novalidate>
        ...
        <div class="tab-content mb-3" id="ex2-content">
            <div class="tab-pane fade show active" id="ex3-tabs-1" role="tabpanel" aria-labelledby="ex3-tab-1">
                <div class="card border border-0 mt-3 text-center">
                    ...
                    <img id="show" src="<?php echo asset('app/views/assets/img/no_img.png'); ?>" class="img-fluid"
                         alt="upload">
                </div>
            ...
            <div class="tab-pane fade" id="ex3-tabs-2" role="tabpanel" aria-labelledby="ex3-tab-2">
                <div class="video-container mt-3 text-center">
                    <div class="input-group mb-3">
                        <input type="text" name="videolink" class="form-control" id="video-link"
        ...
        <div class="sticky-sm-bottom bg-body row">
            <div class="col px-0 d-grid gap-2">
                <?php echo Form::button(__('global.save'), [
                    'type' => 'submit',
                    'form' => 'form-add',
                    'class' => 'btn btn-success save m-2'
                ]); ?>
            </div>
            <div class="col px-0 d-grid gap-2">
