    ...
    <div class="d-flex mt-3 mb-3">
        ...
        <div class="ps-2">
            <div class="input-group border-03">
                ...
                <label class="input-group-text"><svg class="bi" width="16" height="16"><use href="#bi-funnel"></use></svg></label>
            </div>
        </div>
    </div>
<?php if ($posts->count): ?>
        ...
        <a href="<?php echo Uri::to('admin/posts/edit/' . $article->id); ?>" class="mt-3 text-decoration-none">
            <div class="d-flex align-items-center border-top pt-3 pb-3">
                <div class="pl-2 col-md-11 col-sm-11 col-11 py-1">
                    ...
                    <br>
                        <span>
                            <?php echo __('posts.views'); ?>: <?php echo Post::getViewsCount($article->id); ?> |
                            <?php echo __('posts.likes'); ?>: <?php echo Post::getLikesCount($article->id); ?> |
                            <?php echo __('posts.comments'); ?>: <?php echo Post::getCommentsCount($article->id); ?>
                        </span>
                    </p>
                    <!---->
                </div>
                <div class="ml-auto d-none d-md-inline pl-3">
                    <div class="mx-3 align-middle">
                        ...
                        <?php else: ?>
                            <?php $image = Uri::to('app/views/assets/img/no_image.png'); ?>
                        <?php endif; ?>
