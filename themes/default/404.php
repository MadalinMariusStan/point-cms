...
<head>
    ...
    <title><?php echo site_name(); ?> - error: status code 404</title>
...
<div class="container py-5 mt-3">
    <section class="row">
            ...
            <div class="text-center">
                <svg viewBox="0 0 900 600" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M118.142 373.556c31.081 18.628 75.673 1.408 75.673 1.408s-5.831-47.416-36.931-66.023c-31.081-18.629-75.654-1.429-75.654-1.429s5.83 47.416 36.912 66.044z"
                          fill="url(#d)"/>
                    <circle cx="747.028" cy="208.246" r="12.989" transform="rotate(180 747.028 208.246)"
                            fill="#666AF6"/>
                    <circle cx="257.822" cy="281.817" r="14.612" transform="rotate(180 257.822 281.817)"
                            fill="#666AF6"/>
                    <circle r="12.177" transform="matrix(-1 0 0 1 159.929 195.932)" fill="#666AF6"/>
                    <circle r="5.683" transform="matrix(-1 0 0 1 635.635 259.251)" fill="#666AF6"/>
                    ...
                    <path d="M787.973 327.261h.214c1.271 18.011 14.666 18.288 14.666 18.288s-14.77.288-14.77 21.1c0-20.812-14.771-21.1-14.771-21.1s13.389-.277 14.661-18.288zM248.445 502.359h.19c1.128 16.301 13.014 16.552 13.014 16.552s-13.106.261-13.106 19.096c0-18.835-13.106-19.096-13.106-19.096s11.88-.251 13.008-16.552z"
                          fill="#E1E4E5"/>
                    <rect x="221.128" y="128.304" width="461.792" height="344.342" rx="4.194" fill="#fff"
                          stroke="#E1E4E5" stroke-width="4"/>
                    <path d="M404.574 247.969v23.992m95.978-23.992v23.992m35.801 108.38s-31.442-30.145-83.879-30.145c-52.436 0-83.879 30.145-83.879 30.145"
                          stroke="#666AF6" stroke-width="33.798" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <rect x="285.191" y="141.65" width="13.347" height="13.347" rx="6.673" fill="#fff" stroke="#E1E4E5"
                          stroke-width="4.194"/>
                    <defs>
                        <linearGradient id="a" x1="462.603" y1="856.045" x2="446.439" y2="-532.412"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#fff"/>
                            <stop offset="1" stop-color="#EEE"/>
                        </linearGradient>
                        <linearGradient id="b" x1="623.412" y1="386.251" x2="510.865" y2="-119.486"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#fff"/>
                            <stop offset="1" stop-color="#EEE"/>
                        </linearGradient>
                        <linearGradient id="c" x1="702.485" y1="324.123" x2="898.687" y2="168.927"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#fff"/>
                            <stop offset="1" stop-color="#EEE"/>
                        </linearGradient>
                        <linearGradient id="d" x1="238.418" y1="433.519" x2="-11.673" y2="201.151"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#fff"/>
                            <stop offset="1" stop-color="#EEE"/>
                        </linearGradient>
        ...
        <h1 class="fw-light text-center">Page not found</h1>
        <p class="text-center">Unfortunately, the page <code>/<?php echo htmlspecialchars(current_url()); ?></code> could not be found.</p>
        <p class="text-center">Take me <a class="btn btn-outline-dark" href="<?php echo base_url(); ?>">home</a></p>
</div>
</section>

<footer class="footer mt-auto mt-5 py-3 text-center">
    <div class="container">
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin'); ?>">Admin area</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>" title="Return to my website.">Home</a>
            </li>
        </ul>
        <span class="fw-light text-muted"> <?php echo site_name(); ?> <small>&copy; <?php echo date('Y'); ?>.
                    All rights reserved.</small> Hand-crafted &amp; made with <i
